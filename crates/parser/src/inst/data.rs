...
super::impl_inst_build! {Memcopy, (dest: ValueId, src: ValueId, len: ValueId)}
...
super::impl_inst_build! {ObjAtomicLoad, (object: ValueId)}
super::impl_inst_build! {ObjAtomicStore, (object: ValueId, value: ValueId)}
