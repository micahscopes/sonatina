...
fn speed_inliner_config() -> InlinerConfig {
    InlinerConfig {
        ...
        enable_full_inliner: true,
        splice_max_insts: 4,
        max_inlinee_blocks: 12,
        max_inlinee_insts: 48,
        max_multi_use_inlinee_blocks: 10,
        max_multi_use_inlinee_insts: 32,
        max_growth_per_caller: 128,
        max_total_growth: 640,
        max_inline_depth: 4,
        inline_threshold: 16,
        inline_threshold_cold: 8,
        single_use_bonus: 10,
        leaf_bonus: 3,
        loop_penalty: 32,
